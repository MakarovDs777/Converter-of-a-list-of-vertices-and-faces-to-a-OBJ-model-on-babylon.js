...
[Converter of a list of vertices and faces to a OBJ model on babylon.js(Version15-14v but each picture has its own tuple) | Babylon.js Playground](https://playground.babylonjs.com/#A0AM0V#2)
